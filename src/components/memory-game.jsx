...
const MemoryGame = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-grey-100 p-4">
      <h1 className="text-5xl font-bold font-mono mb-6   ">Memory Game</h1>
      {/* Input */}
      <div className="mb-5 border bg-gray-100  rounded-lg">
        <label htmlFor="gridSize" className="mr-2 mb-6 ml-2">
          Grid Size: (max 10)
        </label>
        <input
          type="number"
          ...
          className="border-2 mr-2 mt-2 mb-2 border-gray-300 rounded px-2 py-1"
        />
      </div>
      ...
      {/* Result */}
      {won && (
        <div className="mt-4 text-6xl font-bold text-green-600 animate-bounce">
          You Won!
        </div>
      )}
